export const COLOR_RANGES = [
  ...
  { color: "#1468e1", label: "Young-Mid (White)", range: [5000, 20000] },
  { color: "#ffd700", label: "Middle-Aged (Yellow)", range: [20000, 50000] },
  { color: "#ff8c00", label: "Older (Orange)", range: [50000, 100000] },
  { color: "#ff4500", label: "Aging (Red-Orange)", range: [100_000, 1000_000] },
  { color: "#8b0000", label: "Old (Dark Red)", range: [1000000, 3000_000] },
